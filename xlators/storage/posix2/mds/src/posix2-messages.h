...
#define POSIX2_MSG_EXPORT_NO_XASUP                 (POSIX2_COMP_BASE + 5)

#define POSIX2_MSG_EXPORT_INVAL_VOLID              (POSIX2_COMP_BASE + 6)

#define POSIX2_MSG_EXPORT_MISSING_VOLID            (POSIX2_COMP_BASE + 7)

#define POSIX2_MSG_EXPORT_VOLID_FAILURE            (POSIX2_COMP_BASE + 8)

#define POSIX2_MSG_EXPORT_INVAL_ROOT_GFID          (POSIX2_COMP_BASE + 9)
