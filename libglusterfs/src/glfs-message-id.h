...
#define GLFS_MSGID_COMP_DHT2      GLFS_MSGID_COMP_WRITE_BEHIND_END
#define GLFS_MSGID_COMP_DHT2_END  (GLFS_MSGID_COMP_DHT2 + GLFS_MSGID_SEGMENT)

#define GLFS_MSGID_COMP_POSIX2_DS      GLFS_MSGID_COMP_DHT2_END
#define GLFS_MSGID_COMP_POSIX2_DS_END  (GLFS_MSGID_COMP_POSIX2_DS +\
                                       GLFS_MSGID_SEGMENT)
